...
const stats = [
  ...
  { value: "90 Days", label: "Warranty Period" },
];

const values = [
  { icon: Clock, title: "Speed", description: "We repair your device at your doorstep within 30 minutes. No waiting, no shop visits." },
  { icon: Shield, title: "Trust", description: "All repairs backed by 90-day warranty. We use genuine quality parts certified for performance." },
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <div className="space-y-4 text-[#EAF7FF]/70 text-base leading-relaxed">
              ...
              <p>
                Our team of 50+ certified technicians is trained to handle all major brands and all types of repairs. We use genuine quality parts and provide a 90-day warranty on every repair.
              </p>
            </div>
          </motion.div>
        </div>
