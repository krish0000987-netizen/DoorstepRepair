...
export async function seedDatabase() {
  ...
  if (existingContent.length === 0) {
    const defaultContent = [
      ...
      { section: "terms", key: "warranty_charges_content", value: "If the Problem in the replaced part is informed within 24 hours after replacement then no extra charges will applicable. If the problem is reported after that we will arrange revisit and Rs.499 will be applicable as technician visit charge in the case of onsite servicing." },
      ...
      { section: "terms", key: "payment_content", value: "You can make payment via cash, Paytm, Google Pay, Phone Pe or Online Payment after the repair is completed." },
      { section: "terms", key: "faulty_parts_title", value: "Replace Faulty Parts" },
      { section: "terms", key: "faulty_parts_content", value: "Replace faulty parts must be submitted to our technician after repair/services of your device otherwise warranty will not be covered." },
      { section: "terms", key: "service_charges_title", value: "Service/Visit Charges" },
      { section: "terms", key: "service_charges_content", value: "A minimum service/visit charges of Rs.499/- has to be paid in case of deny to repair or job will not completed or estimate cost will not approved." },
